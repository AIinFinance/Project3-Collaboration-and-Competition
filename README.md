...
In order to train an agent, open `Collaboration_and_Competition.ipynb` on Jupyter Notebook and run the code by pressing Shift+Enter or clicking Run button.
